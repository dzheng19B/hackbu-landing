...
| k | Srcset triple agreement | **PASS** *(re-verified 2026-09-03 after the artwork swap to the 1448×1086 aerial illustration)* | `src/lib/images.ts:29` and `scripts/generate-images.mjs:97` both `[640, 960, 1280, 1448, 2172, 2896, 4344, 5792]`; `index.html`'s `imagesrcset` carries the same eight rungs; the only artwork `sizes` is `((pointer: coarse) and (max-width: 767px)) 965px, ((pointer: coarse) and (max-height: 500px)) 965px, (min-aspect-ratio: 1448/1086) 300vw, 400vh`, identical between the preload and the `<picture>`; headless Chromium selected `Campus-5792.avif` at 1900×912@1x and 1440×900@2x and `Campus-2896.avif` at 390×844@3x and 844×390@3x, one campus fetch each |
